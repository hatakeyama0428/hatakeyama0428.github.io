...
　　　  '$$ f{(x)}は下に凸のグラフでf{(p)}が＜0となるので、pより小さい値で、f{(\\alpha)}=0となる\\alphaが存在する。 $$'+
  ...
  var n5=0;  
      function display_eq5(){
         if(n5%2 == 0){ 
            ...
            '$$ 接するとき判別式\\;D=0となるので、 $$'+
            '$$ \\frac{D}{4}=a^2(a-3)^2-(a^2-1)・\\left\\{(a-3)^2-5\\right\\}=0 $$'+
            '$$a^2(a-3)^2-a^2(a-3)^2+5a^2-(a-3)^2+5=0 $$'+
            '$$ 5a^2-a^2+6a-9+5=0 $$'+
            '$$ 4a^2+6a-4=0 $$'+
            '$$ 2a^2+3a-2=0 $$'+
            '$$ (2a-1)(a+2)=0 $$'+
...
　　　  '$$ 直線{\\rm AI}は\\angle{BAC}を２等分するから、\\frac{AB}{AC}=\\frac{BD}{DC} $$'+
...
'　　　　　　　　　　(1)　 3つの方程式の範囲を図示すると１になる。<br><br>   '+ 
'　　　　　　　　　　(2)　\\(x=1\\)のとき、\\(\\log_2 1=0\\)、\\(2^1=2\\)より、格子点は、\\((x,y)=(1,0)、(1,1)、(1,2)\\)の3個ある。<br><br>'+
'　　　　　　　　　　(3)　底\\(2\\)は\\(1\\)より、大きいから、\\(\\log_2 2＜\\log_2 3＜\\log_2 4、\\)つまり、\\(1＜\\log_2 3＜2\\)となる。<br> '+
'　　　　　　　　　　　　よって\\(m=1\\)となる。 <br>'+ 
'　　　　　　　　　　　　\\( x=18\\)のとき、\\(2^3=8\\)である。また\\(1＜\\log_2 3＜28\\)より、\\(格子点の数は8-1=7\\)である。<br><br> '+
'　　　　　　　　　　(4)　\\(\\log_2 n\\)が整数かどうか、\\(n\\)が\\(2\\)の累乗数かどうかで場合分けして調べる。<br> '+
'　　　　　　　　　　　(ⅰ)　\\(n\\)が\\(2\\)の累乗数であるとき、<br> '+
'　　　　　　　　　　　　\\(x＞0、y≦2^x\\)で、直線\\(x=n\\)上にある格子点の個数は、\\(2^n\\)個である。<br> '+
'　　　　　　　　　　　　\\(x＞0、y＜\\log_2 x\\)で、直線\\(x=n\\)上にある格子点の個数は、\\(\\log_2 n-1\\)個である。<br> '+
'　　　　　　　　　　　　以上より、領域\\(D\\)内にあって、\\(x=n\\)上にある格子点の個数は、\\(2^n-\\log_2 n-1\\)個である。<br> <br>'+
'　　　　　　　　　　　(ⅱ)　(ⅰ)でないとき、 <br>'+
'　　　　　　　　　　　　\\(x＞0、y≦2^x\\)で、直線\\(x=n\\)上にある格子点の個数は、\\(2^n\\)個である。<br>'+
'　　　　　　　　　　　　\\(x＞0、y＜\\log_2 x\\)で、直線\\(x=n\\)上にある格子点の個数は、\\(\\log_2 n\\)個である。<br> '+
'　　　　　　　　　　　　以上より、領域\\(D\\)内にあって、\\(x=n\\)上にある格子点の個数は、\\(2^n-\\log_2 n\\)個である。 <br>'+
'　　　　　　　　　　(5)　\\(1\\)から\\(31\\)までの自然数のうち、\\(2\\)の累乗数は\\(1、2、4、8、16\\)の\\(5\\)つある。<br> <br>'+
'　　　　　　　　　　　　領域\\(D\\)ないにあって、\\(1≦x≦31\\)にある格子点の個数は、'+
            '$$ \\sum_{k=1}^{31}(2^k -[\\log_2 k])+1・5 $$'+
　　　　　　'$$ =2・\\frac{2^{31} -1}{2-1}-([\\log_2 1]+[\\log_2 2]+・・・+[\\log_2 31])+5 $$'+
            '$$ =2^{32}-2-(0+1・2+2・4+3・8+4・16)+5=2^{32}-95 $$'+
'　　　　　　　　　　　　よって解答は、\\((1)a　１  　(2)ア　３  　(3)イ　１　ウ　７\\) <br>'+
'　　　　　　　　　　　　　　　　　　　\\((4)b　３　c　１　d　２  　(5)エ　３　オ　２　カ　９　キ　５\\) <br>';
            MathJax.Hub.Queue(["Typeset",MathJax.Hub]);
            n17+=1;
         }else{
            document.getElementById("MyEquation17").innerHTML='  ';
